...
SlangParser::BlockContext* SlangParser::block() {
  ...
  try {
    ...
    _errHandler->sync(this);
    _la = _input->LA(1);
    while (_la == SlangParser::T__10

    || _la == SlangParser::IDENTIFIER) {
      setState(81);
...
SlangParser::SimpleExpressionContext* SlangParser::simpleExpression() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & ((1ULL << SlangParser::T__11)
      | (1ULL << SlangParser::T__12)
      | (1ULL << SlangParser::T__13))) != 0)) {
      setState(99);
...
SlangParser::TermContext* SlangParser::term() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & ((1ULL << SlangParser::T__14)
      | (1ULL << SlangParser::T__15)
      | (1ULL << SlangParser::T__16)
      | (1ULL << SlangParser::T__17))) != 0)) {
      setState(104);
...
SlangParser::SignedFactorContext* SlangParser::signedFactor() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (_la == SlangParser::T__11

    || _la == SlangParser::T__12) {
      setState(108);
...
SlangParser::ExpressionContext* SlangParser::AssignmentStatementContext::expression() {
  return getRuleContext<SlangParser::ExpressionContext>(0);
}

tree::TerminalNode* SlangParser::AssignmentStatementContext::IDENTIFIER() {
  return getToken(SlangParser::IDENTIFIER, 0);
}
...
SlangParser::AssignmentStatementContext* SlangParser::assignmentStatement() {
  ...
  try {
    enterOuterAlt(_localctx, 1);
    setState(126);
    dynamic_cast<AssignmentStatementContext *>(_localctx)->ref = match(SlangParser::IDENTIFIER);
    setState(127);
    match(SlangParser::T__6);
    setState(128);
    expression();
...
std::vector<std::string> SlangParser::_literalNames = {
  ...
  "':='", "'INT'", "'BOOL'", "'LONG'", "'STRUCTURED_STATEMENT'", "'+'", 
  "'-'", "'OR'", "'*'", "'/'", "'MOD'", "'AND'", "'NOT'", "", "", "", "'='", 
  "'<>'", "'<'", "'<='", "'>='", "'>'"
};
...
std::vector<std::string> SlangParser::_symbolicNames = {
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
  "", "", "WS", "IDENTIFIER", "NUM_INT", "EQUAL", "NOT_EQUAL", "LT", "LE", 
  "GE", "GT"
};
...
SlangParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x1e, 0x20, 0x22, 0x24, 0x26, 0x28, 0x2a, 0x2, 0x7, 0x3, 0x2, 0xa, 0xc, 
    0x3, 0x2, 0x19, 0x1e, 0x3, 0x2, 0xe, 0x10, 0x3, 0x2, 0x11, 0x14, 0x3, 
    0x2, 0xe, 0xf, 0x2, 0x7c, 0x2, 0x2c, 0x3, 0x2, 0x2, 0x2, 0x4, 0x2e, 
    ...
    0x7, 0x3, 0x2, 0x2, 0x2f, 0x33, 0x7, 0x17, 0x2, 0x2, 0x30, 0x32, 0x5, 
    ...
    0x45, 0x7, 0x17, 0x2, 0x2, 0x45, 0x46, 0x7, 0x7, 0x2, 0x2, 0x46, 0x48, 
    0x5, 0xe, 0x8, 0x2, 0x47, 0x49, 0x5, 0xc, 0x7, 0x2, 0x48, 0x47, 0x3, 
    0x2, 0x2, 0x2, 0x48, 0x49, 0x3, 0x2, 0x2, 0x2, 0x49, 0x4a, 0x3, 0x2, 
    0x2, 0x2, 0x4a, 0x4b, 0x7, 0x8, 0x2, 0x2, 0x4b, 0xb, 0x3, 0x2, 0x2, 
    0x2, 0x4c, 0x4d, 0x7, 0x9, 0x2, 0x2, 0x4d, 0x4e, 0x5, 0xc, 0x7, 0x2, 
    ...
    0x7, 0xd, 0x2, 0x2, 0x5e, 0x17, 0x3, 0x2, 0x2, 0x2, 0x5f, 0x62, 0x5, 
    ...
    0x5, 0x2a, 0x16, 0x2, 0x74, 0x75, 0x7, 0x15, 0x2, 0x2, 0x75, 0x78, 0x5, 
    0x20, 0x11, 0x2, 0x76, 0x78, 0x5, 0x22, 0x12, 0x2, 0x77, 0x73, 0x3, 
    0x2, 0x2, 0x2, 0x77, 0x74, 0x3, 0x2, 0x2, 0x2, 0x77, 0x76, 0x3, 0x2, 
    0x2, 0x2, 0x78, 0x21, 0x3, 0x2, 0x2, 0x2, 0x79, 0x7a, 0x7, 0x18, 0x2, 
    0x2, 0x7a, 0x23, 0x3, 0x2, 0x2, 0x2, 0x7b, 0x7c, 0x9, 0x3, 0x2, 0x2, 
    0x7c, 0x25, 0x3, 0x2, 0x2, 0x2, 0x7d, 0x7e, 0x5, 0x28, 0x15, 0x2, 0x7e, 
    0x7f, 0x7, 0x8, 0x2, 0x2, 0x7f, 0x27, 0x3, 0x2, 0x2, 0x2, 0x80, 0x81, 
    0x7, 0x17, 0x2, 0x2, 0x81, 0x82, 0x7, 0x9, 0x2, 0x2, 0x82, 0x83, 0x5, 
    0x18, 0xd, 0x2, 0x83, 0x29, 0x3, 0x2, 0x2, 0x2, 0x84, 0x85, 0x7, 0x17, 
